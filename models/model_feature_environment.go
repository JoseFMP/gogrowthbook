...
// checks if the FeatureEnvironment type satisfies the common.MappedNullable interface at compile time
var _ common.MappedNullable = &FeatureEnvironment{}
...
type _FeatureEnvironment FeatureEnvironment

// NewFeatureEnvironment instantiates a new FeatureEnvironment object
...
// NewFeatureEnvironmentWithDefaults instantiates a new FeatureEnvironment object
...
func (o *FeatureEnvironment) GetDraft() FeatureEnvironmentDraft {
	if o == nil || common.IsNil(o.Draft) {
		var ret FeatureEnvironmentDraft
		return ret
	}
	return *o.Draft
}
...
func (o *FeatureEnvironment) SetDraft(v FeatureEnvironmentDraft) {
	o.Draft = &v
}
...
func (o *FeatureEnvironment) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFeatureEnvironment := _FeatureEnvironment{}

	err = json.Unmarshal(bytes, &varFeatureEnvironment)

	if err != nil {
		return err
	}

	*o = FeatureEnvironment(varFeatureEnvironment)

	return err
}

type NullableFeatureEnvironment struct {
	value *FeatureEnvironment
	isSet bool
}

func (v NullableFeatureEnvironment) Get() *FeatureEnvironment {
	return v.value
}

func (v *NullableFeatureEnvironment) Set(val *FeatureEnvironment) {
	v.value = val
	v.isSet = true
}
...
func NewNullableFeatureEnvironment(val *FeatureEnvironment) *NullableFeatureEnvironment {
	return &NullableFeatureEnvironment{value: val, isSet: true}
}
