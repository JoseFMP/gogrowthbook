...
// checks if the FeatureEnvironmentDraft type satisfies the common.MappedNullable interface at compile time
var _ common.MappedNullable = &FeatureEnvironmentDraft{}
...
type _FeatureEnvironmentDraft FeatureEnvironmentDraft

// NewFeatureEnvironmentDraft instantiates a new FeatureEnvironmentDraft object
...
// NewFeatureEnvironmentDraftWithDefaults instantiates a new FeatureEnvironmentDraft object
...
func (o *FeatureEnvironmentDraft) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFeatureEnvironmentDraft := _FeatureEnvironmentDraft{}

	err = json.Unmarshal(bytes, &varFeatureEnvironmentDraft)

	if err != nil {
		return err
	}

	*o = FeatureEnvironmentDraft(varFeatureEnvironmentDraft)

	return err
}

type NullableFeatureEnvironmentDraft struct {
	value *FeatureEnvironmentDraft
	isSet bool
}

func (v NullableFeatureEnvironmentDraft) Get() *FeatureEnvironmentDraft {
	return v.value
}

func (v *NullableFeatureEnvironmentDraft) Set(val *FeatureEnvironmentDraft) {
	v.value = val
	v.isSet = true
}

func (v NullableFeatureEnvironmentDraft) IsSet() bool {
	return v.isSet
}

func (v *NullableFeatureEnvironmentDraft) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeatureEnvironmentDraft(val *FeatureEnvironmentDraft) *NullableFeatureEnvironmentDraft {
	return &NullableFeatureEnvironmentDraft{value: val, isSet: true}
}
