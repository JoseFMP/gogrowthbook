...
// checks if the ListOrganizations200Response type satisfies the common.MappedNullable interface at compile time
var _ common.MappedNullable = &ListOrganizations200Response{}
...
type _ListOrganizations200Response ListOrganizations200Response
...
func NewListOrganizations200Response(limit interface{}, offset interface{}, count interface{}, total interface{}, hasMore interface{}, nextOffset interface{}, organizations []Organization) *ListOrganizations200Response {
...
func (o *ListOrganizations200Response) GetLimit() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *ListOrganizations200Response) GetLimitOk() (*interface{}, bool) {
...
func (o *ListOrganizations200Response) SetLimit(v interface{}) {
	o.Limit = v
}

// GetOffset returns the Offset field value
// If the value is explicit nil, the zero value for interface{} will be returned
func (o *ListOrganizations200Response) GetOffset() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ListOrganizations200Response) GetOffsetOk() (*interface{}, bool) {
...
func (o *ListOrganizations200Response) SetOffset(v interface{}) {
	o.Offset = v
}

// GetCount returns the Count field value
// If the value is explicit nil, the zero value for interface{} will be returned
func (o *ListOrganizations200Response) GetCount() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ListOrganizations200Response) GetCountOk() (*interface{}, bool) {
...
func (o *ListOrganizations200Response) SetCount(v interface{}) {
	o.Count = v
}

// GetTotal returns the Total field value
// If the value is explicit nil, the zero value for interface{} will be returned
func (o *ListOrganizations200Response) GetTotal() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ListOrganizations200Response) GetTotalOk() (*interface{}, bool) {
...
func (o *ListOrganizations200Response) SetTotal(v interface{}) {
	o.Total = v
}

// GetHasMore returns the HasMore field value
// If the value is explicit nil, the zero value for interface{} will be returned
func (o *ListOrganizations200Response) GetHasMore() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ListOrganizations200Response) GetHasMoreOk() (*interface{}, bool) {
...
func (o *ListOrganizations200Response) SetHasMore(v interface{}) {
	o.HasMore = v
}

// GetNextOffset returns the NextOffset field value
// If the value is explicit nil, the zero value for interface{} will be returned
func (o *ListOrganizations200Response) GetNextOffset() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ListOrganizations200Response) GetNextOffsetOk() (*interface{}, bool) {
...
func (o *ListOrganizations200Response) SetNextOffset(v interface{}) {
	o.NextOffset = v
}
...
func (o *ListOrganizations200Response) UnmarshalJSON(bytes []byte) (err error) {
	...
	varListOrganizations200Response := _ListOrganizations200Response{}

	err = json.Unmarshal(bytes, &varListOrganizations200Response)

	if err != nil {
		return err
	}

	*o = ListOrganizations200Response(varListOrganizations200Response)
