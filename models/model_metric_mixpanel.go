...
// checks if the MetricMixpanel type satisfies the common.MappedNullable interface at compile time
var _ common.MappedNullable = &MetricMixpanel{}
...
type _MetricMixpanel MetricMixpanel

// NewMetricMixpanel instantiates a new MetricMixpanel object
...
// NewMetricMixpanelWithDefaults instantiates a new MetricMixpanel object
...
// GetEventValueOk returns a tuple with the EventValue field value
// and a boolean to check if the value has been set.
...
func (o *MetricMixpanel) GetConditions() []PostMetricRequestMixpanelConditionsInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *MetricMixpanel) GetConditionsOk() ([]PostMetricRequestMixpanelConditionsInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MetricMixpanel) SetConditions(v []PostMetricRequestMixpanelConditionsInner) {
	o.Conditions = v
}
...
func (o *MetricMixpanel) UnmarshalJSON(bytes []byte) (err error) {
	...
	varMetricMixpanel := _MetricMixpanel{}

	err = json.Unmarshal(bytes, &varMetricMixpanel)

	if err != nil {
		return err
	}

	*o = MetricMixpanel(varMetricMixpanel)

	return err
}

type NullableMetricMixpanel struct {
	value *MetricMixpanel
	isSet bool
}

func (v NullableMetricMixpanel) Get() *MetricMixpanel {
	return v.value
}

func (v *NullableMetricMixpanel) Set(val *MetricMixpanel) {
	v.value = val
	v.isSet = true
}
...
func NewNullableMetricMixpanel(val *MetricMixpanel) *NullableMetricMixpanel {
	return &NullableMetricMixpanel{value: val, isSet: true}
}
