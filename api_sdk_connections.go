...
func (r ApiGetSdkConnectionRequest) Execute() (*models.GetSdkConnection200Response, *http.Response, error) {
	return r.ApiService.GetSdkConnectionExecute(r)
}
...
func (a *SdkConnectionsAPIService) GetSdkConnectionExecute(r ApiGetSdkConnectionRequest) (*models.GetSdkConnection200Response, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *models.GetSdkConnection200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SdkConnectionsAPIService.GetSdkConnection")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/sdk-connections/{id}"
...
func (r ApiListSdkConnectionsRequest) Execute() (*models.ListSdkConnections200Response, *http.Response, error) {
	return r.ApiService.ListSdkConnectionsExecute(r)
}
...
func (a *SdkConnectionsAPIService) ListSdkConnectionsExecute(r ApiListSdkConnectionsRequest) (*models.ListSdkConnections200Response, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *models.ListSdkConnections200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SdkConnectionsAPIService.ListSdkConnections")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/sdk-connections"
	...
	if r.withProxy != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "withProxy", r.withProxy, "")
	}
	if r.multiOrg != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "multiOrg", r.multiOrg, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
