...
// APIClient manages communication with the GrowthBook REST API API v1.0.0
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.SavedGroupsAPI = (*SavedGroupsAPIService)(&c.common)
	c.SdkConnectionsAPI = (*SdkConnectionsAPIService)(&c.common)
	c.SegmentsAPI = (*SegmentsAPIService)(&c.common)
	c.VisualChangesetsAPI = (*VisualChangesetsAPIService)(&c.common)
...
func parameterValueToString( obj interface{}, key string ) string {
	...
	var param,ok = obj.(common.MappedNullable)
	if !ok {
		return ""
	}
...
func parameterAddToHeaderOrQuery(headerOrQueryParams interface{}, keyPrefix string, obj interface{}, collectionType string) {
	...
	if v == reflect.ValueOf(nil) {
		...
		switch v.Kind() {
			...
			case reflect.Struct:
				if t,ok := obj.(common.MappedNullable); ok {
					dataMap,err := t.ToMap()
					if err != nil {
						return
					}
